...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop StakeShare server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "StakeShare server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* StakeShare features */
        {"stakeshare", "masternode", &masternode, true, true, false},
        {"stakeshare", "listmasternodes", &listmasternodes, true, true, false},
        {"stakeshare", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stakeshare", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stakeshare", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stakeshare", "masternodedebug", &masternodedebug, true, true, false},
        {"stakeshare", "startmasternode", &startmasternode, true, true, false},
        {"stakeshare", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stakeshare", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stakeshare", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stakeshare", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stakeshare", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stakeshare", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stakeshare", "mnbudget", &mnbudget, true, true, false},
        {"stakeshare", "preparebudget", &preparebudget, true, true, false},
        {"stakeshare", "submitbudget", &submitbudget, true, true, false},
        {"stakeshare", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stakeshare", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stakeshare", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stakeshare", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stakeshare", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stakeshare", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stakeshare", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stakeshare", "checkbudgets", &checkbudgets, true, true, false},
        {"stakeshare", "mnsync", &mnsync, true, true, false},
        {"stakeshare", "spork", &spork, true, true, false},
        {"stakeshare", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"stakeshare", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use stakeshared, or the -server option to stakeshare-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> stakeshare-cli " + methodname + " " + args + "\n";
}
