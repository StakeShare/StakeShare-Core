                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received StakeShare from zSSX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSSX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSSX));
