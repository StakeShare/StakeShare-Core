                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StakeShare Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a StakeShare address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stakeshare: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSSX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About StakeShare Core"), this);
    aboutAction->setStatusTip(tr("Show information about StakeShare Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StakeShare"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your StakeShare addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified StakeShare addresses"));
    ...
    openAction->setStatusTip(tr("Open a StakeShare: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StakeShare Core help message to get a list with possible StakeShare command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StakeShare Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StakeShare network", "", count));
}
...
{
    QString strTitle = tr("StakeShare Core"); // default title
...
/** Creates context menu, its actions, and stakeshares up all the relevant signals for mouse events. */
