...
/** Utility functions used by the StakeShare Qt UI.
 */
namespace GUIUtil
{
...
// Render StakeShare addresses in monospace font
...
// Parse "stakeshare:" URI into recipient object, return true on successful parsing
