...
public:
    ...
    void setZStakeShareControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSSX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSSX_clicked();
    void on_pushButtonZStakeShareControl_clicked();
