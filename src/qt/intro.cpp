...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("StakeShare Core"),
     ...
     * override -datadir in the stakeshare.conf file in the default data directory
     * (to be consistent with stakeshared behavior)
     */
    if (dataDir != getDefaultDataDirectory())
