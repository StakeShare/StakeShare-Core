...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000b973ca5dd2774b52be79f7c61137ca94f33c389b04b4fc9fad97ba49421"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1538207189, // * UNIX timestamp of last checkpoint block
...
public:
	...
	vAlertPubKey = ParseHex("042e062b77c7e786466743bef0ab910f51b7e790c3252533ef756e1cd64811dbcbd77f084f091b5793199687e0cff4a0dc7ef704c7a0b67087730f6a29903d2ac6");
        nDefaultPort = 5515;
	...
	const char* pszTimestamp = "Faith is a living, daring confidence in God's grace, so sure and certain that a man could stake his life on it a thousand times";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04bed1fde902fad33fa04913e17057467a08ecb9bb3593fa8603cc50014beba261532b335d50e8948f77a2f8db2331a3611b67283ffb8ab35a72a7d2cc1e9da023") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1538207189;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1507880;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b973ca5dd2774b52be79f7c61137ca94f33c389b04b4fc9fad97ba49421"));
        assert(genesis.hashMerkleRoot == uint256("0x6c9a7034ee0208970dab7b821a7bf12a34f507fabcc5de9593682d295f8bfd1b"));

        vSeeds.push_back(CDNSSeedData("206.189.98.151", "206.189.98.151"));
        vSeeds.push_back(CDNSSeedData("178.128.64.250", "178.128.64.250"));
        vSeeds.push_back(CDNSSeedData("209.97.178.7", "209.97.178.7"));
	...
	strSporkKey = "04EE61DCA045072DC0704EA88F19D97F75A4203C6F8091C62DBC18774528385F7925A6F9EA3555C6E808691083889C0B69C88779D91387B32CA79752FB9BC0AE24";
        strObfuscationPoolDummyAddress = "SgwLSp459gxNgR8YXixEH67eHqbRGgb2UN";
        nStartMasternodePayments = 1538207189;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // StakeShare: 1 day
        nTargetSpacing = 1 * 60;  // StakeShare: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet stakeshare addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet stakeshare script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet stakeshare BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet stakeshare BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet stakeshare BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // StakeShare: 1 day
        nTargetSpacing = 1 * 60;        // StakeShare: 1 minutes
