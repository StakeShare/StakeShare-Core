...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StakeShare Core stakeshare-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stakeshare-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stakeshare transaction") + "\n" +
                               "  stakeshare-tx [options] -create [commands]   " + _("Create hex-encoded stakeshare transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stakeshare transaction
