...
In order to support loading of multiple wallets in stakeshare-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stakeshare.cpp.
...
Changes to stakeshare.cpp
----------------------
stakeshare.cpp is the entry point into stakeshare-qt, and as such, will require some minor modifications to provide hooks for
