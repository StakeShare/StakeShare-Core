...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/stakeshare-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/stakeshare-cli.cpp \
           src/stakeshare-tx.cpp \
           src/stakeshare.cpp \
           src/db.cpp \
           ...
           src/qt/stakeshare.cpp \
           src/qt/stakesharestrings.cpp \
...
RESOURCES += src/qt/stakeshare.qrc src/qt/stakeshare_locale.qrc

TRANSLATIONS += src/qt/locale/stakeshare_bg.ts \
                src/qt/locale/stakeshare_de.ts \
                src/qt/locale/stakeshare_en.ts \
                src/qt/locale/stakeshare_es.ts \
                src/qt/locale/stakeshare_fi.ts \
                src/qt/locale/stakeshare_fr.ts \
                src/qt/locale/stakeshare_it.ts \
                src/qt/locale/stakeshare_ja.ts \
                src/qt/locale/stakeshare_pl.ts \
                src/qt/locale/stakeshare_pt.ts \
                src/qt/locale/stakeshare_ru.ts \
                src/qt/locale/stakeshare_sk.ts \
                src/qt/locale/stakeshare_sv.ts \
                src/qt/locale/stakeshare_vi.ts \
                src/qt/locale/stakeshare_zh_CN.ts \
                src/qt/locale/stakeshare_zh_TW.ts
