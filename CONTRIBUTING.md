Contributing to StakeShare Core
============================

The StakeShare Core project operates an open contributor model where anyone is
...
The following applies to code changes to the StakeShare Core project, and is not to be
confused with overall StakeShare Network Protocol consensus changes.

Whether a pull request is merged into StakeShare Core rests with the project merge
...
Patches that change StakeShare consensus rules are considerably more involved than
...
Where a patch set proposes to change the StakeShare consensus, it must have been
...
The project leader is the release manager for each StakeShare Core release.
